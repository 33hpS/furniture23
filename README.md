        ...
        <main class="bg-white p-6 rounded-b-lg shadow-lg mb-6">
            ...
            <section class="mb-8">
                ...
                <div class="mt-4 bg-blue-50 p-4 rounded-lg">
                    ...
                    <p class="mt-2">Мебельная фабрика "Гарант Азия" существует на рынке Кыргызстана с 2010 года и специализируется на производстве качественной мебели для дома и офиса. В ассортименте компании: кухонные гарнитуры, шкафы-купе, спальные гарнитуры, офисная мебель и другие изделия по индивидуальным заказам.</p>
                        ...
                        <div class="flex flex-col md:flex-row gap-4">
                            <div class="md:w-1/3">
                                <div class="aspect-w-16 aspect-h-9 bg-gray-200 rounded-lg overflow-hidden">
                                    <[img src="/api/placeholder/600/400" alt="Пильный центр KDT 832" class="w-full h-full object-cover"](https://ligamac.ru/upload/iblock/c6d/9k7n1ksruijdvf6v484opl4xa5y0ctma.jpg)>
                                </div>
                            </div>
                            <div class="md:w-2/3">
